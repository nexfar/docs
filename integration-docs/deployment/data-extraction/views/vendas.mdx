...
1. [Combos](/deployment/data-extraction/views/combos) - Promoções de produtos agrupados
2. [Impostos e Margens](/deployment/data-extraction/views/impostos-margens) - Cálculos fiscais
3. [Documentos Fiscais](/deployment/data-extraction/views/documentos-fiscais) - Notas e documentações
