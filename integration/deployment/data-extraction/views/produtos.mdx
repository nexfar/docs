...
1. [Pedidos](/integration/deployment/data-extraction/views/pedidos) - Integração de pedidos
2. [Vendas](/integration/deployment/data-extraction/views/vendas) - Histórico de vendas
