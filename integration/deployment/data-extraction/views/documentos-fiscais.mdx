...
<Note>
  Estas VIEWs complementam as demais categorias. Certifique-se de ter implementado [Cadastros Básicos](/integration/deployment/data-extraction/views/cadastros-basicos) primeiro.
</Note>
