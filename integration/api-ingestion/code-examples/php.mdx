...
// Configuração da API
$apiUrl = "https://ingestion.nexfar.com.br";
...
- **$apiUrl**: Endereço do ambiente sandbox. Para produção, use `https://ingestion.nexfar.com.br`
  ...
  <Accordion title="CURLE_COULDNT_CONNECT - Erro de Conexão">
    ...
    **Solução:**
    ...
    2. Teste conectividade:
       ```bash
       ping ingestion.nexfar.com.br
       curl -I https://ingestion.nexfar.com.br
       ```
