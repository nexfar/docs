...
- **API_URL**: Endereço do ambiente sandbox. Para produção, use `https://ingestion.nexfar.com.br`
...
- **customFields**: Campos personalizados (dict)
- **extraParams**: Parâmetros extras (dict)
  ...
  <Accordion title="Connection Refused - Erro de Conexão">
    ...
    **Solução:**
    1. Verifique se a URL está correta:
       ...
       - Produção: `https://ingestion.nexfar.com.br`
