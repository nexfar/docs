...
<Steps>
  ...
  <Step title="Testar Conectividade com Health Check">
    ...
    ```bash
    curl https://api.nexfar.com.br/api/health
    ```
  ...
  <Step title="Consultar Histórico no Audit Log">
    ...
    ```bash
    curl -X GET "https://api.nexfar.com.br/api/v1/audit-log?date_from=today" \
      -H "Authorization: Bearer $NEXFAR_JWT"
    ```
...
<Step title="Criar Nova Requisição">
  ...
  3. URL: `https://api.nexfar.com.br/api/v1/clients`
</Step>
