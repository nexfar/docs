...
```bash
curl -X POST https://ingestion.nexfar.com.br/api/v1/auth/email/login \
...
```bash
curl -X POST https://ingestion.nexfar.com.br/api/v1/users \
  -H "Content-Type: application/json" \
...
```bash
curl -X GET https://ingestion.nexfar.com.br/api/v1/users?page=1&limit=10 \
...
```bash
curl -X PATCH https://ingestion.nexfar.com.br/api/v1/users/{user-id} \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer SEU_TOKEN_ADMIN" \
  -d '{
...
```bash
curl -X DELETE https://ingestion.nexfar.com.br/api/v1/users/{user-id} \
  -H "Authorization: Bearer SEU_TOKEN_ADMIN"
```
...
curl -X PATCH https://ingestion.nexfar.com.br/api/v1/auth/me \
  -H "Content-Type: application/json" \
...
```bash
curl -X GET https://ingestion.nexfar.com.br/api/v1/audit-logs?userId={admin-id} \
  -H "Authorization: Bearer SEU_TOKEN_ADMIN"
```
...
curl -X GET "https://ingestion.nexfar.com.br/api/v1/users?filters[email]=$eq:novo.admin@nexfar.com.br" \
  -H "Authorization: Bearer SEU_TOKEN_ADMIN"
```
...
curl -X GET https://ingestion.nexfar.com.br/api/v1/auth/me \
  -H "Authorization: Bearer SEU_TOKEN"
...
- [Autenticação JWT](/integration/api-ingestion/authentication)
- [Ambientes (Sandbox vs Produção)](/integration/api-ingestion/environments)
- [Logs de Auditoria](/integration/api-ingestion/audit-log)
