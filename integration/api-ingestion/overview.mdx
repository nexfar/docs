...
A API de Ingestão suporta **ambos os protocolos** para os mesmos 31 modelos de dados. Escolha o que melhor se adapta ao seu stack tecnológico:
...
A API de Ingestão suporta **31 modelos de dados** organizados em 6 categorias. Todos os modelos são mapeados 1:1 das Database Views (`VIEW_NEXFAR_*`) existentes — o nome do modelo aqui corresponde ao sufixo da VIEW equivalente.
...
<AccordionGroup>
  ...
  <Accordion title="Pedidos e Vendas (4 modelos)" icon="cart-shopping">
...
<Steps>
  ...
  <Step title="Explorar Documentação">
    ...
    Escolha REST ou GraphQL conforme sua preferência - ambos suportam os mesmos 31 modelos.
  </Step>
  ...
  <Step title="Promover para Produção">
    ...
    1. Valide que todos os 31 modelos necessários foram testados
...
<CardGroup cols={2}>
  ...
  <Card title="REST API Reference" icon="code" href="/api-reference">
    Explore todos os 31 endpoints REST interativamente com exemplos de request/response
  </Card>
