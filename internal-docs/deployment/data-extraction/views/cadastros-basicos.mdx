...
1. [Produtos](/deployment/data-extraction/views/produtos) - Catálogo de produtos e relacionamentos
2. [Pedidos](/deployment/data-extraction/views/pedidos) - Cabeçalho e itens de pedidos
3. [Vendas](/deployment/data-extraction/views/vendas) - Histórico de vendas
